...
const Testimonial = () => {
    const array = [{ name: 'Jane Doe', designation: 'Admin', testimonialDescription: 'This platform made organizing our last election a breeze. The voting process was smooth, and the results were transparent.', keyWord: 'Gentlewoman'},{ name: 'Asif Talukder', designation: 'Student', testimonialDescription: "Voting was so easy! I loved how secure and straightforward the process was.", keyWord: 'Gentleman'},{ name: 'Eva Williams', designation: 'Candidate', testimonialDescription: "The real-time results feature is amazing. I felt more connected to the election process than ever before.", keyWord: 'Individual'},{ name: 'Eva Williams', designation: 'Candidate', testimonialDescription: "The real-time results feature is amazing. I felt more connected to the election process than ever before.", keyWord: 'Individual'}];
                    ...
                    <div key={idx} className="p-4 min-w-full md:min-w-[50%]">
                        <div className="h-full p-8 rounded shadow-[0px_4px_12px_rgba(0,0,0,0.1)]">
                            ...
                            <a className="inline-flex items-center">
                                <img className="w-12 h-12 rounded-full flex-shrink-0 object-cover object-center" src={`https://media.licdn.com/dms/image/v2/D5603AQGFvZnnkd85DA/profile-displayphoto-shrink_400_400/profile-displayphoto-shrink_400_400/0/1702706933085?e=1730332800&v=beta&t=_VFAOXKxvOSQl0NyZNOxTMm_e6A5B6LE4PuBlRHMusg`} alt="carousel navigate ui"  />
