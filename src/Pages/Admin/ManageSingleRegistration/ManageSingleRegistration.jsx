...
const ManageSingleRegistration = () => {
  ...
  return (
    <div className="max-w-screen-lg m-auto">
        ...
        >
          <div className="bg-[#f2f8fff3] relative text-[7px] md:text-sm lg:text-lg">
            ...
            >
              ...
              <div className="grid mt-1 md:mt-4 grid-cols-2  gap-x-2 md:gap-4">
                {/* SSC Passing year */}
                ...
                <div className="flex mb-0.5  lg:mb-1 md:gap-5">
                  <label className="w-20 md:mt-2">Driver:</label>
                  <label className=" w-auto md:mt-2">
                    {participant?.driver}
                  </label>
                </div>
              </div>
              <div className="grid md:mt-4 grid-cols-2 gap-x-2 md:gap-4">
                <div className="flex gap-3 md:gap-4 justify-start">
                  <label className="w-20 md:w-48">Registration Fee self:</label>
          ...
          <div className="bg-[#fff5f8e2] relative pb-1 md:pb-5">
            <div className="px-2 md:px-10 space-y-1 lg:space-y-3 text-[7px] md:text-base">
              <div className="flex gap-5 mb-3 lg:mb-5 justify-around">
                ...
                <div className="md:text-lg text-white bg-[rgb(42,46,151)] p-0.5 px-2 rounded-b-lg md:rounded-b-xl pt-2">
                  রেজিস্ট্রেশন ফর্ম
                </div>
              ...
              <div className="grid mt-1 md:mt-4 grid-cols-2 gap-4">
                <div className="flex justify-start">
                  <label className="w-20 md:w-48">Registration Fee self:</label>
                  <label>{participant?.participantFee} BDT</label>
                </div>
                <div className="flex justify-start">
                  <label className="w-20 md:w-48">
                ...
                <div className="flex justify-start">
                  <label className="w-20 md:w-48">Total Fee :</label>
                  <label>{participant?.total_fee} BDT</label>
                </div>
              </div>
            </div>
      ...
      <div className="mt-5 flex flex-wrap gap-5">
        <Link
          to={`/dashboard/update/participant/${participant?.participantId}`}
...
export default ManageSingleRegistration;
